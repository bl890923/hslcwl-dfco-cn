...
function headNavPosition(MARK, SID) {
    ...
    if (MARK == "product") {
        if (SID.length > 8 && (SID.indexOf("0001,0045") > -1 || SID.indexOf("0001,0046") > -1)) {
...
function $a(sMsg, boxType, autoClose, focusElmId, sTitle, behavior) {
    ...
    if (jMesbook1.length == 0) {
        ...
        var sHtml = "<div class='tanchuang1' id='mesbook1'>"
            + "<div class='conBox'>"
            + "<div class='tcClose'><img onclick='hideMsg()' id='mesbook1ImgClose' src='images/tanchaung_close.png' alt='关闭' /></div>"
            + "<div class='box b1'>"
            //+ "<img id='mesbook1Icon' src='images/tanchuang2_icon01.png' alt='' />"
...
function submitOrder(src, _oid) {
    ...
    $.post("/ajax.ashx?action=submitorder&t=" + Math.random(), {
        ...
        if (sta == "1") {
            $a(sMsg, 1);
            $("#txtContact,#txtMobile,#txtEmail,#txtContent").val("");
        } else {
            $a(msg);
            emptyText('tbForm1');
        }
...
function productSelectCurrentPosition(SID) {
    $(".sidebar .box1 dt a[sid='" + SID + "'],.sidebar .box1 dd a[sid='" + SID + "']").addClass("cur");
}
